...
/*********************************************************************************************
* 名称：LCD_Write_GRAM_BlitLine
* 功能: LCD 使用自动填充 绘制一条两色线
* 参数:  x,y：起点，dot：单个字符的行指针 ，len：字节数， color：前景色 ，bc：背景色 
* 返回：
* 修改：
* 注释：
*********************************************************************************************/
...
/*********************************************************************************************
* 名称：Get_HzMat
* 功能: code 字符指针开始，从 GB2312 字库中查找出字模
* 参数: code：字符串的开始地址,GBK码，mat：数据存放地址(size/8+((size%8)?1:0))*(size) bytes大小，size:字体大小
* 返回：
* 修改：
* 注释：
*********************************************************************************************/
...
/*********************************************************************************************
* 名称：LCDDrawGB2312
* 功能: 绘制一个GB2312汉字，暂仅支持32号字体
* 参数: font:具体的文字指针，size:字号
* 返回：
* 修改：
* 注释：具体能够绘制的汉字查询 GB2312 字库表
*********************************************************************************************/
...
/*********************************************************************************************
* 名称：LCDDrawFont32
* 功能: lcd显示32x32汉字（文件字库版）
* 参数: x1,y1:起始坐标值，p 字符  width绘制宽度，color：字体颜色，Bcolor：背景颜色
* 返回：
* 修改：
* 注释：
*********************************************************************************************/
...
/*********************************************************************************************
* 名称：LCDDrawFont40
* 功能: lcd显示40x40汉字（自定义字库），字符使用字符库
* 参数: x1,y1:起始坐标值，gb2：字符，color：字体颜色，Bcolor：背景颜色
* 返回：
* 修改：
* 注释：仅绘制自定义字库内容，不具备换行功能
*********************************************************************************************/
